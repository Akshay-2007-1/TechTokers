      ...
      this.data = {
        ...
        agents: parsed.agents.map((agent) => ({
          ...
          runtimeLimits: {
            ...
            maxRunCpus: agent.runtimeLimits?.maxRunCpus ?? null,
            maxRunMemoryMb: agent.runtimeLimits?.maxRunMemoryMb ?? null,
            maxRunProcesses: agent.runtimeLimits?.maxRunProcesses ?? null,
          },
        })),
